...
import 'package:app_dos_hermanos/features/registration_feature/cubit/register_bloc/register_bloc.dart';
import 'package:app_dos_hermanos/features/registration_feature/widgets/register_button.dart';
import '../../../repositories/authentication_repository.dart';
import '../../../repositories/location_repository.dart';
import '../../../repositories/models/locations.dart';

class RegisterForm extends StatefulWidget {
  final AuthenticationRepository authenticationRepository;
  RegisterForm({Key? key, required this.authenticationRepository})
      : super(key: key);
...
class _RegisterFormState extends State<RegisterForm> {
                  ...
                  FutureBuilder(
                      ...
                      builder: (context, AsyncSnapshot snapshot) {
                        ...
                        return DropdownButtonFormField<String>(
                          ...
                          items:
                              _locations.map<DropdownMenuItem<String>>((value) {
  ...
  void _onFormSubmitted() async {
    ...
    _registerBloc.add(Sumbitted(
        password: _passwordController.text, photoFile: profilePhotoFile));
  }
