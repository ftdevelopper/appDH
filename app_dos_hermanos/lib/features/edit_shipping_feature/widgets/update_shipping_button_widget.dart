...
import '../cubit/edit_shipping_cubit/edit_shipping_cubit.dart';
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                ShippingData(title: 'Arroz', data: context.read<EditShippingCubit>().state.shipping.riceType ?? ''),
                if (shipping.shippingState == ShippingStatus.inTravelShipping)
                  ShippingData(title: 'Humedad', data: context.read<EditShippingCubit>().state.shipping.humidity ?? ''),
                ShippingData(title: 'Chofer', data: context.read<EditShippingCubit>().state.shipping.driverName ?? ''),
                ShippingData(title: 'Camion', data: context.read<EditShippingCubit>().state.shipping.truckPatent ?? ''),
                ShippingData(title: 'Chasis', data: context.read<EditShippingCubit>().state.shipping.chasisPatent ?? ''),
