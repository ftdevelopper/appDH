...
class UpdateShippingButtonWidget extends StatelessWidget {
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            _showConfirmationAlert(
                context.read<EditShippingCubit>().state.shipping, context);
          },
        ),
      ),
    );
  ...
  Future<void> _showConfirmationAlert(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (shipping.shippingState == ShippingStatus.newShipping) ...[
                  ShippingData(
                      title: 'Peso Tara',
                      data: shipping.remiterTara.toString()),
                  ShippingData(
                      title: 'Peso Bruto',
                ...
                if (shipping.shippingState ==
                  ...
                  ShippingData(
                      title: 'Peso Bruto',
                      data: shipping.reciverFullWeight.toString()),
                ],
                if (shipping.shippingState ==
                  ...
                  ShippingData(
                      title: 'Peso Tara',
                      data: shipping.reciverTara.toString()),
                  ShippingData(
                      title: 'Peso Neto',
                      data: shipping.reciverWetWeight.toString()),
                  ShippingData(
                      title: 'Peso Seco',
                      data: shipping.reciverDryWeight.toString()),
                ],
                ElevatedButton(
