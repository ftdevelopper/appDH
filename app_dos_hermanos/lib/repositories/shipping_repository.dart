...
class ShippingRepository {
  ...
  Map<String, String?>_mapShipping(Shipping shipping){
    Map<String, String?> _shippingMap = {
      ...
      'remiterFullWeightTime': shipping.remiterFullWeightTime == null ? null : shipping.remiterFullWeightTime.toString(),
      ...
      'remiterTaraTime': shipping.remiterTaraTime == null ? null : shipping.remiterTaraTime.toString(),
      'remiterTaraUser': shipping.remiterTaraUser,
      'reciverFullWeight': shipping.reciverFullWeight,
      'reciverFullWeightTime': shipping.reciverFullWeightTime == null ? null : shipping.reciverFullWeightTime.toString(),
      ...
      'reciverTaraTime': shipping.reciverTaraTime == null ? null : shipping.reciverTaraTime.toString(),
